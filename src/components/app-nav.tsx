        ...
        return (
          <Link
            ...
            className={cn(
              ...
              active
                ? "bg-indigo-500/10 text-indigo-700 dark:bg-indigo-500/30 dark:text-indigo-100"
                : "text-zinc-600 hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-100/90 dark:hover:bg-zinc-800 dark:hover:text-white",
            )}
          >
            <Icon
              size={16}
